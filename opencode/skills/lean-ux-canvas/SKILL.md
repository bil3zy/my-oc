---
name: lean-ux-canvas
description: Guide teams through Lean UX Canvas v2. Use when framing a business problem, surfacing UX assumptions, defining what to learn next, or validating product/UX decisions. Triggers on: "UX workshop", "lean UX", "business problem", "assumptions", "hypothesis testing", "user outcomes", "experiment design", "product discovery".
metadata:
  author: deanpeters / Jeff Gothelf
...
best_for:
  ...
  - "Aligning UX decisions with business outcomes"
scenarios:
  ...
  - "We're changing the user flow and need to validate assumptions first"
---
...
3. **I'm not sure what the business problem is** — [Agent suggests starting with problem-statement or problem-framing-canvas first]
...
1. **I have personas already** — [Reference proto-persona or paste persona]
...
3. **I need to create personas first** — [Agent suggests using proto-persona component skill]
...
3. **I need to research this first** — [Agent suggests jobs-to-be-done or discovery-interview-prep]
...
2. **Suggest related skills** to use next (e.g., discovery-interview-prep for customer interviews)?
...
**Fix:** Design smallest experiment first. If you can't think of one, use pol-probe-advisor to choose a validation method.
